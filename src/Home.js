...
const Home = (props) => {
    ...
    return (
        ...
        <img src={'/images/Alex-Taormina.JPG'} alt="Taormina, Sicily" className="now-pic" height="50%" width="50%" />
        <br /><div className="home-style">
            <h3 className="cyan">Get in Touch</h3>
            <p>Please don't hesitate to reach out and say hello. I welcome all feedback, suggestions, and thoughts about the site (especially if you spot a bug), and I also welcome all interesting banter and good chats (the more random the topic, the better).</p>
