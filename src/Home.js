...
const Home = (props) => {
    ...
    return (
        ...
        <div className="home-style">
            ...
            <p>I have quite a diverse set of interests, so whoever you are and whatever you like, hopefully there will be something for you on this website, even if it’s just that you know me and simply want to hear what I’m currently up to :)</p>
        </div>
