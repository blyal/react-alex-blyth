                ...
                related: [
                    {
                        ...
                        year: '1999',
                        director: 'Paul Thomas Anderson',
                        img: <img alt="Magnolia" src="images/magnolia-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'The Wolf of Wall Street',
                        year: '2013',
                        director: 'Martin Scorsese',
                        img: <img alt="The Wolf of Wall Street" src="images/wolf-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Network',
                        year: '1976',
                        director: 'Sidney Lumet',
                        img: <img alt="Network" src="images/network-small.webp" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                related: [
                    {
                        ...
                        year: '2014',
                        director: 'Paul Thomas Anderson',
                        img: <img alt="Inherent Vice" src="images/inherent-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Burn After Reading',
                        year: '2008',
                        director: 'Joel and Ethan Coen',
                        img: <img alt="Burn After Reading" src="images/burn-after-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'O Brother Where Art Thou?',
                        year: '2000',
                        director: 'Joel and Ethan Coen',
                        img: <img alt="O Brother Where Art Thou" src="images/o-brother-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                related: [
                    {
                        ...
                        img: <img alt="Star Wars" src="images/star-wars-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Harry Potter series',
                        year: '2001–11',
                        director: 'Created by J.K. Rowling',
                        img: <img alt="Harry Potter Film Series" src="images/hp-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Game of Thrones TV series',
                        year: '2011–19',
                        director: 'Created by George R.R. Martin',
                        img: <img alt="Game of Throne TV series" src="images/got-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                description: ['I’m sometimes a tad nervous when one of my favourite directors comes out with a new movie, because there’s always the chance that they underwhelm me. Some directors I have to wait 4–5 years for them to come out with something new, as was the case with Quentin Tarantino when he made this movie (I’m not going to write the title over and over again). Luckily for me, he absolutely knocked this one out of the park. It’s not that hard when you have Leo DiCaprio and Brad Pitt together in front of the camera, as well as the likes of Al Pacino in the supporting cast. God damn, this movie rules! The writing is awesome, the soundtrack is great, and the final sequence just blows your mind it’s so awesome. I admit I may be a bit biased, because this movie is extra awesome if you’re a film geek and know a bit of the history behind the semi–true story being portrayed. In any case, though. Go watch it, now!'],
                related: [
                    {
                        title: 'Inglourious Basterds',
                        year: '2007',
                        director: 'Quentin Tarantino',
                        img: <img alt="Inglourious Basterds" src="images/inglourious-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Boogie Nights',
                        year: '1997',
                        director: 'Paul Thomas Anderson',
                        img: <img alt="Boogie Nights" src="images/boogie-nights-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Hail, Caesar!',
                        year: '2016',
                        director: 'Joel and Ethan Coen',
                        img: <img alt="Hail, Caesar!" src="images/hail-caesar-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                related: [
                    ...
                    },
                    {
                        ...
                        year: '2007',
                        director: 'Paul Thomas Anderson',
                        img: <img alt="There Will Be Blood" src="images/twbb-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Nashville',
                        year: '1975',
                        director: 'Robert Altman',
                        img: <img alt="Nashville" src="images/nashville-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                related: [
                    ...
                    },
                    {
                        ...
                        year: '2007',
                        director: 'Joel and Ethan Coen',
                        img: <img alt="No Country for Old Men" src="images/no-country-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: '2001: A Space Odyssey',
                        year: '1968',
                        director: 'Stanley Kubrick',
                        img: <img alt="2001: A Spacy Odyssey" src="images/2001-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                related: [
                    {
                        ...
                        year: '1991',
                        director: 'Richard Linklater',
                        img: <img alt="Dazed and Confused" src="images/dazed-and-small.jpg" height="80%" width="80%" />
                    },
                    {
            ...
            },
            {
                ...
                related: [
                    ...
                    },
                    {
                        ...
                        img: <img alt="The Godfather" src="images/godfather-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Casino',
                        year: '1995',
                        director: 'Martin Scorsese',
                        img: <img alt="Casino" src="images/casino-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                related: [
                    {
                        ...
                        img: <img alt="The NeverEnding Story" src="images/neverending-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Inside Out',
                        year: '2015',
                        director: 'Pete Docter',
                        img: <img alt="Inside Out" src="images/inside-out-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Spirited Away',
                        year: '2001',
                        director: 'Hayao Miyazaki',
                        img: <img alt="Spirited Away" src="images/spirited-away-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                related: [
                    {
                        ...
                        year: '1995',
                        director: 'Joel and Ethan Coen',
                        img: <img alt="Fargo" src="images/fargo-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'There Will Be Blood',
                        year: '2007',
                    ...
                    },
                    {
                        ...
                        year: '1984',
                        director: 'Joel and Ethan Coen',
                        img: <img alt="Blood Simple" src="images/blood-simple-small.jpg" height="80%" width="80%" />
                    }
                ]
            }
        ],
        favDirectors: [
            {
                ...
                recommendations: [
                    ...
                    },
                    {
                        ...
                        year: '2002',
                        img: <img alt="Punch-Drunk Love" src="images/punch-drunk-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                recommendations: [
                    {
                        title: 'The Big Lebowski',
                        year: '1998',
                        img: <img alt="The Big Lebowski" src="images/big-lebowski-small.jpeg" height="80%" width="80%" />
                    },
                    {
                        title: 'No Country for Old Men',
                        year: '2007',
            ...
            },
            {
                ...
                recommendations: [
                    ...
                    },
                    {
                        title: 'Waking Life',
                        year: '2001',
                        img: <img alt="Waking Life" src="images/waking-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Before Sunrise',
                        year: '1995',
                        img: <img alt="Before Sunrise" src="images/before-sunrise-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                recommendations: [
                    {
                        title: 'Pulp Fiction',
                        year: '1994',
                        img: <img alt="Pulp Fiction" src="images/pulp-small.jpeg" height="81%" width="81%" />
                    },
                    {
                        title: 'Inglourious Basterds',
                        year: '2007',
                    ...
                    },
                    {
                        title: 'Once Upon a Time in Hollywood',
                        year: '2019',
                        img: <img alt="Once Upon a Time in Hollywood" src="images/hollywood-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Django Unchained',
                        year: '2012',
                        img: <img alt="Django Unchained" src="images/django-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                recommendations: [
                    {
                        title: 'Goodfellas',
                        year: '1991',
                        img: <img alt="Goodfellas" src="images/goodfellas-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'The Wolf of Wall Street',
                        year: '2013',
                    ...
                    },
                    {
                        title: 'The Departed',
                        year: '2006',
                        img: <img alt="The Departed" src="images/departed-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Raging Bull',
                        year: '1980',
                        img: <img alt="Raging Bull" src="images/raging-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                recommendations: [
                    ...
                    },
                    {
                        ...
                        year: '2004',
                        img: <img alt="Howl's Moving Castle" src="images/howl's-moving-small.png" height="80%" width="80%" />
                    },
                    {
                        title: 'Laputa – Castle in the Sky',
                        year: '1986',
                        img: <img alt="Laputa — Castle in the Sky" src="images/laputa-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: "Kiki's Delivery Service",
                        year: '1989',
                        img: <img alt="Kiki's Delivery Service" src="images/kiki's-delivery-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                recommendations: [
                    {
                        ...
                        year: '2014',
                        img: <img alt="The Grand Budapest Hotel" src="images/the-small-budapest-hotel.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Fantastic Mr Fox',
                        year: '2009',
                        img: <img alt="Fantastic Mr Fox" src="images/fantastic-mr-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Rushmore',
                        year: '1998',
                        img: <img alt="Rushmore" src="images/rushmore-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'The Royal Tenenbaums',
                        year: '2001',
                        img: <img alt="The Royal Tenenbaums" src="images/the-royal-small.jpg" height="80%" width="80%" />
                    }
                ]
            },
            {
                ...
                recommendations: [
                    {
                        ...
                        year: '2001',
                        img: <img alt="Mulholland Drive" src="images/mulholland-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Wild at Heart',
                        year: '1990',
                        img: <img alt="Wild at Heart" src="images/wild-at-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Twin Peaks: Fire Walk with Me',
                        year: '1992',
                        img: <img alt="Twin Peaks: Fire Walk with Me" src="images/twin-peaks-small.jpg" height="80%" width="80%" />
                    },
                    {
                        title: 'Blue Velvet',
                        year: '1986',
                        img: <img alt="Blue Velvet" src="images/blue-velvet-small.jpg" height="80%" width="80%" />
                    }
                ]
            }
        ]
