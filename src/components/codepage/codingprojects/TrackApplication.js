    ...
    render() {
        return (
            <div>
                ...
                <div style={{textAlign: 'center', marginRight: '1em'}}>
                    <img src={'images/track-screenshot-4.png'} alt="Screenshot of Track app" height='227.25' width='658.5'/>
                </div>
                <p>
