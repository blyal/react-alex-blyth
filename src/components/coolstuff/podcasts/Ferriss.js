        ...
        <div className="ferriss-pocket">  
            <div>
                ...
                <div className="pocket-blurb">
                    ...
                    <p>
                        I've been a listener of this podcast for over five years now, and it has had a huge impact on my life. I was lucky to be introduced to it at a particularly formative time in my life, so was able to incorporate and adopt several of the tools and routines that Ferriss uncovers from his guests.
                ...
                <div className="recommended-things ferriss-recommendations">
                    ...
                    <div className="mobile-recommendations">
                                ...
                                <div className="mob-rec"><a href="https://tim.blog/2015/09/25/jocko-willink/" target="_blank" rel="noopener noreferrer"><div><img alt="Logo" src="images/ferriss-show.jpeg" height="30%" width="30%"/><span>The Scariest Navy SEAL Imaginable…And What He Taught Me (#107)</span></div></a></div>
