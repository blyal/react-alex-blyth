        ...
        return (
            <div>
                ...
                <div style={{textAlign: 'center', marginRight: '1em'}}>
                    <img src={'images/mentalist-jane.jpg'} alt="Picture of Patrick Jane from The Mentalist" height='100%' width='100%'/>
                </div>
                <p>
                ...
                <div style={{textAlign: 'center', marginRight: '1em'}}>
                    <img src={'images/mentalist-lisbon.jpg'} alt="Picture of Teresa Lisbon from The Mentalist" height='100%' width='100%'/>
                </div>
                <p>
                ...
                <div style={{textAlign: 'center', marginRight: '1em'}}>
                    <img src={'images/mentalist-redjohn.jpg'} alt="Picture of The Red John symbol from The Mentalist" height='100%' width='100%'/>
                </div>
                <p>
                ...
                <div style={{textAlign: 'center', marginRight: '1em'}}>
                    <img src={'images/mentalist-cho.jpg'} alt="Picture of Cho from The Mentalist" height='100%' width='100%'/>
                </div>
                <p>
